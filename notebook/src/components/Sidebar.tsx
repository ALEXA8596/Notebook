...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center py-4 bg-gray-100 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 space-y-6 overflow-hidden">
      <button className="p-2 hover:bg-gray-200 dark:hover:bg-gray-800 rounded" title="Graph View">
        <Network size={24} />
      </button>
      
      <button className="p-2 hover:bg-gray-200 dark:hover:bg-gray-800 rounded" title="Search">
        <Search size={24} />
      </button>
      ...
      <button className="p-2 hover:bg-gray-200 dark:hover:bg-gray-800 rounded" title="Settings">
        <Settings size={24} />
      </button>
    </div>
  );
